...
# Example usage (this is optional, you can modify or remove this part as needed)
if __name__ == "__main__":
    # Define model parameters (adjust based on your model requirements)
    batch_size = 4
    num_features = 64
    num_nodes = 10
    num_timesteps = 12
    
    # Create a dummy input tensor with the shape (batch_size, num_features, num_nodes, num_timesteps)
    input_tensor = torch.randn(batch_size, num_features, num_nodes, num_timesteps)
    
    # Instantiate the model
    model = STGCNChebGraphConv(Ks=3, Ko=3, blocks=[64, 128, 256], n_vertex=num_nodes, in_channels=num_features, out_channels=128)
